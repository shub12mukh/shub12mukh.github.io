...
<!-- Login Form Modal -->
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<h4>Forgot <a href=""> Password?</a></h4>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="signupform" role="form"  method="POST" action="mysql_signup.php">
							...
							<div class="form-group">
								<button id="signUp" type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span>Sign Up</button>
							</div>
						</form>
	...
	<div class="row forLarge"> 
		...
		<div class="forSmall" id="smallIm">
			<img src="pfs.jpg" alt="Snow" style="width:100%;height: 800px;">
			<button class="btn" onclick="location.href='#mainContent';" ><span>How it works </span></button>
		</div>		
	...
	<!-- Main Content After Carousel -->
		<div class="container" id="mainContent"><h1 style="text-align:center;padding-top:50px;">Getting Accommodation is now a few clicks Away</h1>
			<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
				<div class="w3-content">
					<div class="w3-twothird">
						  ...
						  <h5 class="w3-padding-32 w3-text-grey">STEP 5. Look Into <b>'Matches Found'</b> And contact the owner. </h5>
					</div>

					<div class="w3-third w3-center">
					  <img src="lookingfor.gif" style="border-radius: 35px;"></img>
					</div>
				</div>
			</div>
			...
			<div class="w3-row-padding w3-padding-64 w3-container">
			  <div class="w3-content">
				<div class="w3-third w3-center">
					  <img src="roomie.gif" style="border-radius: 35px;"></img>
				</div>
				...
				<div class="w3-twothird">
				  ...
				  <h5 class="w3-padding-32">STEP 4. Look Into <span class="glyphicon glyphicon-phone-alt"></span> 'Request For Contact' details</h5>
				  <h5 class="w3-padding-32">STEP 5. Share your phone number whom you choose .</h5>
				</div>
			  </div>
			</div>
		</div>
